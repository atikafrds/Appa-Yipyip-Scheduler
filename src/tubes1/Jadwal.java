...
public class Jadwal {
    ...
    public Jadwal(String nm, String rg, String mulai, String selesai, String dur, String hr, int idxRuang) {
...
/*    public int getIdxRuang() {
        return this.idxRuang;
    } */
...
/*    public void setIdxRuang(int idx) {
        this.idxRuang = idx;
    } */
    ...
    public Jadwal randomJadwal() {
        ...
        do {
            ...
            if (getRuangan().equals("-")) {
                ...
                // temp.setIdxRuang(RoomManager.getRoomByName(this.getRuangan()));
            }
        } while (!isInDomain(temp, RoomManager.getRoomByRuang(temp.getRuangan())));
        System.out.println("Random done matkul" + this.getNamaKegiatan());
        return temp;
    }
